...
namespace Membrane.Foundation.Runtime.Security
{
	...
	/// alpha-numeric character; it will not start with a special symbol.
	/// </summary>
	public class RandomPasswordStrategy
		: IPasswordGenerationStrategy
	{
		#region - Constants & static fields -

		/// <summary>
		/// Default minimum length of a generated password.
		/// </summary>
		private static int DEFAULT_MIN_PASSWORD_LENGTH = 8;

		/// <summary>
		/// Default maximum length of a generated password.
		/// </summary>
		private static int DEFAULT_MAX_PASSWORD_LENGTH = 10;

		/// <summary>
		/// The allowed lower case characters.
		/// </summary>
		private static string PASSWORD_CHARS_LOWER_CASE = "abcdefgijkmnopqrstwxyz";

		/// <summary>
		/// The allowed upper case characters.
		/// </summary>
		private static string PASSWORD_CHARS_UPPER_CASE = "ABCDEFGHJKLMNPQRSTWXYZ";

		/// <summary>
		/// The allowed numerical characters.
		/// </summary>
		...
		{
			return Generate(RandomPasswordStrategy.DEFAULT_MIN_PASSWORD_LENGTH, RandomPasswordStrategy.DEFAULT_MAX_PASSWORD_LENGTH);
		}
		...
		public string Generate(int minLength, int maxLength)
		{
			...
			char[][] charGroups = new char[][] 
									{
										PASSWORD_CHARS_LOWER_CASE.ToCharArray(),
										PASSWORD_CHARS_UPPER_CASE.ToCharArray(),
